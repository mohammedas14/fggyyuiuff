...
const myid = ['716946561929838632'];//Angry Black هنا بتحط الايدى تبع حسابك و هو رقم طول
...
client5.login(process.env.TOKEN5);//Angry Black
client6.login(process.env.TOKEN6);//Angry Black
//copyright © Angry Black 2020.//❦Angry Black❦
...
client.on('message', message => {
    if(message.content === prefix+'number'){
        message.channel.send(" My Token Is ``1`` ")//Angry Black
    }
});//Angry Black

client2.on('message', message => {
    if(message.content === prefix+'number'){
        message.channel.send(" My Token Is ``2`` ")//Angry Black
    }
});//Angry Black

client3.on('message', message => {
    if(message.content === prefix+'number'){
        message.channel.send(" My Token Is ``3`` ")//Angry Black
    }
});//Angry Black

client4.on('message', message => {
    if(message.content === prefix+'number'){
        message.channel.send(" My Token Is ``4`` ")//Angry Black
    }
});//Angry Black

client5.on('message', message => {
    if(message.content === prefix+'number'){
        message.channel.send(" My Token Is ``5`` ")//Angry Black
    }
});//Angry Black

client6.on('message', message => {
    if(message.content === prefix+'number'){
        message.channel.send(" My Token Is ``6`` ")//Angry Black
    }
});//Angry Black
//copyright © Angry Black 2020.//❦Angry Black❦
...
if (message.content === prefix+'fast') {
      ...
      for(let x = 0; x < 30000; x++) {
        message.channel.send(`**??? ???? ??? **[ " ${x} " ]`)//Angry Black
          .then(m => {
            count++;
          })
